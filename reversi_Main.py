...
import random
from reverse_Functions import Row_Decreasing, Row_Increasing, Col_Decreasing, Col_Increasing, Diag_Decreasing, Diag_Increasing, Diag_Rows_Dec_Cols_Inc, Diag_Rows_Inc_Cols_Dec
